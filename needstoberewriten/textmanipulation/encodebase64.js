...
module.exports.info = {
    name: "encodebase64",
    aliases: ["enbase64", "enb64", "base64"],
    example: "`#PREFIX##COMMAND# <text>`",
    info: "Changes your text",
    tags: ["api","badosz","text","fun","encode","code"]
}
...
module.exports.run = async (client, message, args) => {
    ...
    if (cooldown.has(message.author.id)) {
        ...
        let response = await client.util.requester(`https://obrazium.com/v1/base64?text=${text}`, client.config.tokens.badosz, "json");
